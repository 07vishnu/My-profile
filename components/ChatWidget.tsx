  ...
  return (
    <div className="fixed bottom-6 right-6 z-[150]">
        ...
        >
          <div className="p-6 bg-white border-bottom border-[#dadce0] flex justify-between items-center">
            ...
            <button 
              ...
              className="hover:bg-[#f1f3f4] p-2 rounded-full transition-colors"
              aria-label="Close chat"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#5f6368" strokeWidth="2.5" aria-hidden="true"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
            </button>
          </div>
      ...
      >
        ...
        <div className="absolute -top-1 -right-1 w-4 h-4 bg-[#34a853] rounded-full border-2 border-white animate-pulse" aria-label="Assistant online status indicator"></div>
      </button>
    </div>
  );
};
