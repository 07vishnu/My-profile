    ...
    <div className="min-h-screen relative">
          ...
          <>
            <section id="home" className="container mx-auto px-6 py-20 lg:py-40 flex flex-col items-center text-center relative overflow-visible">
              <div className="mb-12 relative animate-in zoom-in duration-700">
                ...
                <div className="absolute -top-10 -right-20 hidden lg:block animate-bounce">
              ...
              <div className="container mx-auto max-w-5xl">
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                  <div className="reveal active">
                    ...
                    <p className="text-lg text-[#5f6368] leading-relaxed mb-6">I operate at the intersection of legacy reliability and modern scalability. My focus is on ensuring mission-critical availability for massive enterprise server clusters across the globe.</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    {[{ label: "Managed Nodes", v: "16K" }, { label: "Uptime SLA", v: "99.9%" }, { label: "Professional Exp", v: "8Y+" }, { label: "System Health", v: "Healthy" }].map(i => (
                      <div key={i.label} className="bg-white p-8 rounded-2xl border-2 border-[#dadce0] text-center shadow-sm">
            ...
            <section id="experience" className="py-24 px-6 bg-[#f8f9fa]/80 backdrop-blur-md border-y-2 border-[#dadce0]">
              <div className="container mx-auto max-w-4xl">
                <h2 className="text-3xl font-semibold text-[#202124] mb-20 text-center">Career Trajectory</h2>
                <div className="space-y-16">
                  {USER_DATA.experience.map((exp, i) => (
                    <div key={i} className="flex gap-8 group">
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 bg-white border-2 border-[#dadce0] rounded-full flex items-center justify-center text-[#1a73e8] font-bold text-sm shadow-sm group-hover:border-black transition-all">{USER_DATA.experience.length - i}</div>
                      ...
                      <div className="pb-12 flex-1">
                        <div className="google-card p-10 bg-white hover:border-black hover:border-2 transition-all">
                          ...
                          <p className="text-[#1a73e8] font-medium text-lg mb-4">{exp.company}</p>
      ...
      <footer className="py-24 bg-[#f8f9fa] border-t-2 border-[#dadce0] text-center px-6 relative z-10">
        <div className="container mx-auto flex flex-col items-center gap-12">
          <div className="w-full max-w-xs h-12 overflow-hidden bg-[#e8eaed] rounded-lg p-2 text-left font-mono text-[8px] text-[#5f6368] opacity-50">
      ...
      {selectedSkill && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 backdrop-blur-md bg-white/60" onClick={() => setSelectedSkill(null)}>
          <div className="w-full max-w-xl bg-white rounded-[32px] shadow-3xl overflow-hidden relative border-2 border-black p-14" onClick={(e) => e.stopPropagation()}>
            <button onClick={() => setSelectedSkill(null)} className="absolute top-8 right-8 w-12 h-12 hover:bg-[#f1f3f4] rounded-full flex items-center justify-center transition-colors border border-[#dadce0] hover:border-black">✕</button>
